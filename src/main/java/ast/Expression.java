...
public class Expression {
	...
	public boolean isValidExpr(Expression expr) {
		...
		if (expr.getLeftComplexExpr() != null && expr.getRightComplexExpr() != null) {
			boolean leftExpr = isValid(expr.getLeftComplexExpr().getLeft(), expr.getLeftComplexExpr().getRight(),
					expr.getLeftComplexExpr().getOp());
			boolean rightExpr = isValid(expr.getRightComplexExpr().getLeft(), expr.getRightComplexExpr().getRight(),
					expr.getRightComplexExpr().getOp());
